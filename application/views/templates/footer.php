		...
		<footer id=footer>
			<div class=container>
				<p id=copyright>&copy;<?php echo date('Y'); ?> <a title="半岛店 - 精彩近在身边" href="<?php echo base_url(); ?>">半岛店</a> <a title="工业和信息化部网站备案系统" href="http://www.miitbeian.gov.cn" target=_blan rel=nofollowk>鲁ICP备14013078号-2</a> <a href="http://pinggu.zx110.org/review_url_bandaodian.com"><img alt="半岛店网站可信度评估"  src="http://pinggu.zx110.org/images/bs-big.jpg"></a></p>
				<ul id=contact>
				...
				<?php echo '<p>您正在使用' . $browser . '浏览器,' . $os . '操作系统</p>'; ?>
